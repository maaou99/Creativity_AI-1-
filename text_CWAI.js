 // Author: Mariam Aoune
// Date of completion: 17th of January 2022
// Name of file: text_CWAI.js
// The functions below checks for user input 
//and displays text if the input does not respect the conditions
